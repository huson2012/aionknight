package ru.aionknight.commons.configuration.transformers;

import java.lang.reflect.Field;

import ru.aionknight.commons.configuration.PropertyTransformer;
import ru.aionknight.commons.configuration.TransformationException;


/**
 * Transforms String to Byte. String can be in decimal or hex format.
 * {@link ru.aionknight.commons.configuration.TransformationException} will be thrown if something goes wrong
 * 
 * @author SoulKeeper
 */
