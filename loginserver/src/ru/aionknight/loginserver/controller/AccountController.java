package ru.aionknight.loginserver.controller;
...
import ru.aionknight.loginserver.network.aion.AionConnection.State;
import ru.aionknight.loginserver.network.aion.serverpackets.SM_SERVER_LIST;
import ru.aionknight.loginserver.network.aion.serverpackets.SM_UPDATE_SESSION;
import ru.aionknight.loginserver.network.gameserver.GsConnection;
import ru.aionknight.loginserver.network.gameserver.serverpackets.SM_ACCOUNT_AUTH_RESPONSE;
import ru.aionknight.loginserver.network.gameserver.serverpackets.SM_GS_REQUEST_CHARACTER_COUNT;
import ru.aionknight.loginserver.network.gameserver.serverpackets.SM_REQUEST_KICK_ACCOUNT;
import ru.aionknight.loginserver.utils.AccountUtils;
...
public class AccountController
{
	 ...
	 *
	 * If {@link ru.aionknight.loginserver.configs.Config#ACCOUNT_AUTO_CREATION} is enabled - creates new account.<br>
	 *
	 * @param name
	 *            name of account
	 * @param password
	...
	/**
	 * Returns {@link ru.aionknight.loginserver.dao.AccountDAO}, just a shortcut
	 *
	 * @return {@link ru.aionknight.loginserver.dao.AccountDAO}
	 */
	...
	/**
	 * Returns {@link ru.aionknight.loginserver.dao.AccountTimeDAO}, just a shortcut
	 *
	 * @return {@link ru.aionknight.loginserver.dao.AccountTimeDAO}
	 */
