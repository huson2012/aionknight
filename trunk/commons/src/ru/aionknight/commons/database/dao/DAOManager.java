package ru.aionknight.commons.database.dao;

import static ru.aionknight.commons.database.DatabaseFactory.getDatabaseMajorVersion;
import static ru.aionknight.commons.database.DatabaseFactory.getDatabaseMinorVersion;
import static ru.aionknight.commons.database.DatabaseFactory.getDatabaseName;
...
import ru.aionknight.commons.database.DatabaseConfig;
import ru.aionknight.commons.scripting.scriptmanager.ScriptManager;
...
public class DAOManager
{
	...
	/**
	 * This script manager is responsible for loading {@link ru.aionknight.commons.database.dao.DAO} implementations
	 */
	 ...
	 * {@link ru.aionknight.commons.database.dao.DAO#getClassName()} <br>
	 * If another DAO was registed - {@link ru.aionknight.commons.database.dao.DAOAlreadyRegisteredException} will be
	 * thrown
	 * 
	 * @param daoClass
	 *            DAO implementation
