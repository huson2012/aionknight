 ...
 * Author: Skilla
 */
public class AdminChannelMessage extends CustomChannel {
    public AdminChannelMessage() {
        super(LanguageHandler.translate(CustomMessageId.CHANNEL_COMMAND_ADMIN), Player.CHAT_FIXED_ON_ADMIN);
    }
}