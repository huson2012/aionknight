 ...
 * @author Orpheo
 */
public class _1638Lv41WarriorScout extends QuestHandler
{

	private final static int questId = 1638;
	static QuestsData questsData = DataManager.QUEST_DATA;

	public _1638Lv41WarriorScout()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		{
			qe.setNpcQuestData(204548).addOnQuestStart(questId);
			qe.setNpcQuestData(204548).addOnTalkEvent(questId);
