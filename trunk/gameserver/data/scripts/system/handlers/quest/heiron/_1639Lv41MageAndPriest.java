 ...
 * @author Orpheo
 */
public class _1639Lv41MageAndPriest extends QuestHandler {

    private final static int questId = 1639;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _1639Lv41MageAndPriest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(204638).addOnQuestStart(questId);
        qe.setNpcQuestData(204638).addOnTalkEvent(questId);
