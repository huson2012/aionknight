...
public class _1509GoldOrSilverMagePriest extends QuestHandler
{

	private final static int questId = 1509;
	static QuestsData questsData = DataManager.QUEST_DATA;

	public _1509GoldOrSilverMagePriest()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		{
			qe.setNpcQuestData(204637).addOnQuestStart(questId);
			qe.setNpcQuestData(204637).addOnTalkEvent(questId);
