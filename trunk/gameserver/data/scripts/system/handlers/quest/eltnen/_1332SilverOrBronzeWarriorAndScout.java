 ...
 * @author Orpheo
 */
public class _1332SilverOrBronzeWarriorAndScout extends QuestHandler
{
	private static final int questId = 1332;
	static QuestsData questsData = DataManager.QUEST_DATA;

	public _1332SilverOrBronzeWarriorAndScout()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		{
			qe.setNpcQuestData(204011).addOnQuestStart(questId);
