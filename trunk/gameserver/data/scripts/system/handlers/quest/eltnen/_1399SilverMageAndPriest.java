 ...
 */
public class _1399SilverMageAndPriest extends QuestHandler {

    private final static int questId = 1399;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _1399SilverMageAndPriest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(798113).addOnQuestStart(questId);
        qe.setNpcQuestData(798113).addOnTalkEvent(questId);
