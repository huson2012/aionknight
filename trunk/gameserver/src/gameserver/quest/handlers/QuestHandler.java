/**
 * İìóëÿòîğ èãğîâîãî ñåğâåğà Aion 2.7 îò êîìàíäû ğàçğàáîò÷èêîâ 'Aion-Knight Dev. Team' ÿâëÿåòñÿ 
 * ñâîáîäíûì ïğîãğàììíûì îáåñïå÷åíèåì; âû ìîæåòå ğàñïğîñòğàíÿòü è/èëè èçìåíÿòü åãî ñîãëàñíî óñëîâèÿì 
 * Ñòàíäàğòíîé Îáùåñòâåííîé Ëèöåíçèè GNU (GNU GPL), îïóáëèêîâàííîé Ôîíäîì ñâîáîäíîãî ïğîãğàììíîãî 
 * îáåñïå÷åíèÿ (FSF), ëèáî Ëèöåíçèè âåğñèè 3, ëèáî (íà âàøå óñìîòğåíèå) ëşáîé áîëåå ïîçäíåé 
 * âåğñèè.
 * 
