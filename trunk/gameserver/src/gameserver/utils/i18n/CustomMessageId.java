...
{
	WELCOME_VIP("Welcome VIP Member to %s \nCopyright (c) Aion-Knight Dev. Team\nPlease visit our site: http://aion-knight.ru\nSERVER RATES:\nExp Rate: %d\nQuest Rate: %d\nDrop Rate: %d\n"),
	WELCOME_PREMIUM("Welcome Premium Member to %s \nCopyright (c) Aion-Knight Dev. Team\nPlease visit our site: http://aion-knight.ru\nSERVER RATES:\nExp Rate: %d\nQuest Rate: %d\nDrop Rate: %d\n"),
	WELCOME_REGULAR("Welcome to %s \nCopyright (c) Aion-Knight Dev. Team\nPlease visit our site: http://aion-knight.ru\nSERVER RATES:\nExp Rate: %d\nQuest Rate: %d\nDrop Rate: %d\n"),
	SERVER_REVISION("Server Revision: %-6s"),
	WELCOME_BASIC("Welcome to %s \nCopyright (c) Aion-Knight Dev. Team\nPlease visit our site: http://aion-knight.ru"),
