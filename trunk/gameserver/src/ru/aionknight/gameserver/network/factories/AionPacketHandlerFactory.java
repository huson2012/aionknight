...
import ru.aionknight.gameserver.network.aion.AionPacketHandler;
import ru.aionknight.gameserver.network.aion.AionConnection.State;
import ru.aionknight.gameserver.network.aion.clientpackets.*;
...
public class AionPacketHandlerFactory
{
	...
	private void init_2_5()
	{
		...
		addPacket(new CM_MOTION(0xB5), State.IN_GAME);
