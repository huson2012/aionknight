 ...
 * Each desire should implement {@link #handleDesire(ru.aionknight.gameserver.ai.AI)} method with default behaviour.<br>
 * AI can override {@link ru.aionknight.gameserver.ai.AI#handleDesire(Desire)} to implement custom behaviour of desire.<br>
 * 
 * @author SoulKeeper
 * @modified ATracer
 * @see ru.aionknight.gameserver.ai.AI
 * @see ru.aionknight.gameserver.ai.AI#handleDesire(Desire)
 * @see ru.aionknight.gameserver.ai.desires.AbstractDesire
 */
public interface Desire extends Comparable<Desire>
{
	 ...
	 * {@link ru.aionknight.gameserver.ai.desires.DesireQueue#addDesire(Desire)} passing this instance as argument</b>
	 * 
	 * @param desirePower
