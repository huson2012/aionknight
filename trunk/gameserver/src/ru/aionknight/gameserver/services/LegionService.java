...
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_ADD_MEMBER;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_EDIT;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_EMBLEM;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_EMBLEM_SEND;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_INFO;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_LEAVE_MEMBER;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_MEMBERLIST;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_TABS;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_EMBLEM;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_MEMBER;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_NICKNAME;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_SELF_INTRO;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_TITLE;
...
import ru.aionknight.gameserver.network.aion.serverpackets.SM_WAREHOUSE_INFO;
...
import ru.aionknight.gameserver.world.container.LegionContainer;
import ru.aionknight.gameserver.world.container.LegionMemberContainer;
