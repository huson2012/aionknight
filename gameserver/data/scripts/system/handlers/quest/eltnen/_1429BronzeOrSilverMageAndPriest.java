 ...
 * @author Orpheo
 */
public class _1429BronzeOrSilverMageAndPriest extends QuestHandler
{

	private final static int questId = 1429;
	static QuestsData questsData = DataManager.QUEST_DATA;

	public _1429BronzeOrSilverMageAndPriest()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		{
			qe.setNpcQuestData(798112).addOnQuestStart(questId);
			qe.setNpcQuestData(798112).addOnTalkEvent(questId);
	...
	public boolean onDialogEvent(QuestCookie env)
	{
		...
		if(targetId == 798112)
		{
			...
			else if(qs != null && qs.getStatus() == QuestStatus.START)
			{
				...
				{
					if(player.getInventory().getItemCountByItemId(186000002) >= 12)
					{
