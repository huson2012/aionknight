 ...
 * @author Orpheo
 */
public class _2337BronzeMageAndPriest extends QuestHandler {

    private final static int questId = 2337;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _2337BronzeMageAndPriest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(204425).addOnQuestStart(questId);
        qe.setNpcQuestData(204425).addOnTalkEvent(questId);
