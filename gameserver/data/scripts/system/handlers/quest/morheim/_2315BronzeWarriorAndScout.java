 ...
 * @author Orpheo
 */
public class _2315BronzeWarriorAndScout extends QuestHandler {

    private final static int questId = 2315;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _2315BronzeWarriorAndScout() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(204360).addOnQuestStart(questId);
        qe.setNpcQuestData(204360).addOnTalkEvent(questId);
        ...
        if (targetId == 204360) {
            if (qs == null || qs.getStatus() == QuestStatus.NONE) {
                ...
                if (env.getDialogId() == 2) {
                    ...
                    if (player.getInventory().getItemCountByItemId(186000007) >= 3) {
