 ...
 * @author Orpheo
 */
public class _2396SilverWarriorAndScout extends QuestHandler
{
	private static final int questId = 2396;
	static QuestsData questsData = DataManager.QUEST_DATA;

	public _2396SilverWarriorAndScout()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		{
			qe.setNpcQuestData(204359).addOnQuestStart(questId);
			qe.setNpcQuestData(204359).addOnTalkEvent(questId);
