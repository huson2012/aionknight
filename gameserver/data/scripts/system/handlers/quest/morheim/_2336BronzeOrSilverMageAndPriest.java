 ...
 * @author Orpheo
 */
public class _2336BronzeOrSilverMageAndPriest extends QuestHandler
{

	private final static int questId = 2336;
	static QuestsData questsData = DataManager.QUEST_DATA;

	public _2336BronzeOrSilverMageAndPriest()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		{
			qe.setNpcQuestData(204426).addOnQuestStart(questId);
			qe.setNpcQuestData(204426).addOnTalkEvent(questId);
