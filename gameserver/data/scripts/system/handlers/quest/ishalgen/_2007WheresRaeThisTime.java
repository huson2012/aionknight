...
public class _2007WheresRaeThisTime extends QuestHandler 
{
	...
	if (qs.getStatus() == QuestStatus.START) 
	{
		switch (targetId) 
	{
		case 203516: switch (env.getDialogId()) 
	{
		case 26: if (var == 0) return sendQuestDialog(env, 1011);
		case 10000: if (var == 0) 
	{
		...
		break;
		case 203519: switch (env.getDialogId()) 
		{
			case 26: if (var == 1) return sendQuestDialog(env, 1352);
			case 10001: if (var == 1) 
		{
			qs.setQuestVarById(0, var + 1);
			updateQuestStatus(env);
		...
		break;
		case 203539: switch (env.getDialogId()) 
	{
		case 26: if (var == 2) return sendQuestDialog(env, 1693);
		case 1694: PacketSendUtility.sendPacket(player, new SM_PLAY_MOVIE(0, 55));
		break;
		case 10002: if (var == 2) 
	{
		qs.setQuestVarById(0, var + 1);
		...
		return true;
			...
			break;
			case 203552: switch (env.getDialogId()) 
		{
			case 26: if (var == 3) return sendQuestDialog(env, 2034);
			case 10003: if (var == 3) 
		{
			qs.setQuestVarById(0, var + 1);
			updateQuestStatus(env);
		...
		break;
		case 203554: switch (env.getDialogId()) 
	{
		case 26: if (var == 4) return sendQuestDialog(env, 2375);
		...
		case 10005: if (var == 8) 
	{
		...
		return true;
			...
			break;
				case 700081: if (var == 5) 
		{
			destroy(6, env);
			return false;
		}
			break;
			case 700082: if (var == 6) 
		{
			destroy(7, env);
			return false;
		}
			break;
			case 700083: if (var == 7) 
		{
			destroy(-1, env);
			return false;
		}
