 ...
 * @author Orpheo
 */
public class _1569Lv36MageAndPriest extends QuestHandler {

    private final static int questId = 1569;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _1569Lv36MageAndPriest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(204639).addOnQuestStart(questId);
        qe.setNpcQuestData(204639).addOnTalkEvent(questId);
