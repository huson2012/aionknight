...
public class QuestEngine
{
	...
	public void clear()
	{
		npcQuestData.clear(); questItemIds.clear();	questSellBuyItemIds.clear(); questLvlUp.clear();
		questOnEnterWorld.clear(); questOnDie.clear(); questOnKillPlayer.clear(); questEnterZone.clear();
		questMovieEndIds.clear(); questDrop.clear(); questOnQuestFinish.clear(); questOnQuestAbort.clear();
		questOnQuestTimerEnd.clear(); questBonusTypes.clear(); questHandlers.clear(); questOnSkillUse.clear();
		questOnFlyThroughRing.clear(); collectItems.clear();
	}
