...
import ru.aionknight.gameserver.ai.desires.impl.WalkDesire;
 ...
 * 
 * @author SoulKeeper
 * @see ru.aionknight.gameserver.ai.desires.Desire
...
public class DesireQueue extends PriorityBlockingQueue<Desire>
{
	 ...
	 * @see ru.aionknight.gameserver.ai.desires.DesireIteratorFilter#isOk(Desire)
	 * @see ru.aionknight.gameserver.ai.desires.DesireIteratorHandler
	 * @see ru.aionknight.gameserver.ai.desires.DesireIteratorHandler#next(Desire , java.util.Iterator)
	 */
