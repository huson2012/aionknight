 ...
 * @see ru.aionknight.gameserver.ai.desires.DesireQueue
...
public abstract class AbstractDesire implements Desire
{
	...
	/**
	 * Compares this desire with another, used by {@link ru.aionknight.gameserver.ai.desires.DesireQueue} to keep track of
	 * desire priorities.
	 * 
	 * @param o
