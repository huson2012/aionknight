...
import ru.aionknight.gameserver.model.gameobjects.DropNpc;
...
import ru.aionknight.gameserver.model.templates.drops.NpcDrop;
import ru.aionknight.gameserver.model.templates.item.ItemCategory;
...
import ru.aionknight.gameserver.network.aion.serverpackets.SM_GROUP_LOOT;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LOOT_ITEMLIST;
import ru.aionknight.gameserver.network.aion.serverpackets.SM_LOOT_STATUS;
...
import ru.aionknight.gameserver.utils.stats.DropRewardEnum;
...
public class DropService
{
	...
	private DropService()
	{
		...
		{
			for(ru.aionknight.gameserver.model.templates.drops.DropItem di : drop.getDropItems())
			{
